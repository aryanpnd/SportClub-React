...
// import pricingPage from './test.html'
...
export default function Dashboard(props) {
  return (
    <>
      <div className={`dashboardMain bg-${props.darkmodeGradient} `}>
        

        <aside id='dashboardAnim1' className={`ml-[100%] fixed z-10 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-${props.mode2} transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]`}>
          <div>

            <div className="mt-8 text-center">

              <img src={elon} alt="" className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28" />
              <h5 className={`hidden mt-4 text-xl font-semibold text-${props.darkmodeText} lg:block`}>John Doe</h5>
              <span className="hidden text-gray-400 lg:block">Premium</span>
            ...
            <ul className="space-y-2 tracking-wide mt-8">
              ...
              <li>
                <Link to="/dashboard" aria-label="dashboard" className="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400 active:scale-y-75 transition-transform">
              ...
              <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:rounded-xl hover:text-white hover:bg-gradient-to-r from-sky-600 to-cyan-400 active:scale-y-75 transition-transform">
                  ...
                  <span className="group-hover:text-white">Other data</span>
                </a>
              </li>

              <li>
                <Link to="/pricing" className=" mb-2 px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:rounded-xl hover:text-white hover:bg-gradient-to-r from-sky-600 to-cyan-400 active:scale-y-75 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <span className="group-hover:text-white">Change Plan</span>
                </Link>
              </li>
            </ul>

            <div className="px-4 py-3 flex justify-between items-center border-t "></div>

            <Link to="/login" className=" mb-2 px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:rounded-xl hover:text-white hover:bg-gradient-to-br from-red-500 to-red-800 active:scale-y-75 transition-transform">
        ...
        <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%] ">
          ...
          <div className="px-6 pt-6 2xl:container">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div id='dashboardAnim2' className="md:col-span-2 lg:col-span-1">
                <div className={`h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-${props.mode2} `}>
                  
                  <svg className="WeeklyActivitySvg w-40 m-auto opacity-75" viewBox="0 0 146 146" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                    <h5 className={`text-xl text-${props.darkmodeText} text-center`}>Weekly Activities</h5>
                    <div className="mt-2 flex justify-center gap-4">
                      <h3 className="text-3xl font-bold text-green-500">1400 cals</h3>
                    ...
                    <span className="block text-center text-gray-500">Compared to last week <span className='text-red-500'>800 cals</span></span>
                  </div>
                  <table className="w-full text-gray-600">
                    <tbody>
                      <tr>
                        <td className={`py-2 text-${props.darkmodeText}`}>Body fat</td>
                        <td className="text-pink-500">896</td>
                        <td>
                      ...
                      <tr>
                        <td className={`py-2 text-${props.darkmodeText}`}>Calories</td>
                        <td className="text-green-500">1200</td>
                        <td>
                          <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                            <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
                      ...
                      <tr>
                        <td className={`py-2 text-${props.darkmodeText}`}>Total</td>
                        <td className="text-orange-500">12</td>
                        <td>
                          <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                            <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
              ...
              <div>
                <div id='dashboardAnim3' className={`h-full py-6 px-6 rounded-xl border border-gray-200 bg-${props.mode2}`}>
                  <h5 className={`text-3xl text-${props.darkmodeText}`}>Balance</h5>
                  <div className="my-8">
                    <h1 className={`text-5xl font-bold text-${props.darkmodeText}`}>65%</h1>
                    <span className={`text-xl text-green-500`}>₹3000</span>
                  </div>
                  ...
                  <table className={`mt-6 -mb-2 w-full text-${props.darkmodeText}`}>
                    <tbody>
                      <tr>
                        <td className="py-2">Yearly</td>
                        <td className="text-green-500">896</td>
                        <td>
                          <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                            <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
              ...
              <div>
                <div id='dashboardAnim2' className={`h-full py-6 px-6 rounded-xl border border-gray-200 bg-${props.mode2}`}>
                  ...
                  <div className="mt-6">
                    <h5 className={`text-xl text-${props.darkmodeText} text-center`}>Attended</h5>
                    <div className="mt-2 flex justify-center gap-4">
                      <h3 className="text-3xl font-bold text-red-700">28</h3>
                      <div className="flex items-end gap-1 text-green-500">
                        <svg className="w-3" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor" />
                        </svg>
                    ...
                    <span className={`block text-center text-${props.darkmodeText}`}>Compared to last week 13</span>
                  </div>
                  <table className={`mt-6 -mb-2 w-full text-${props.darkmodeText}`}>
                    <tbody>
                      <tr>
                        <td className="py-2">Yearly</td>
                        <td className="text-red-700">70%</td>
                        <td>
                          <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                            <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
                      ...
                      <tr>
                        <td className="py-2">Monthly</td>
                        <td className="text-red-700">67%</td>
                        <td>
                          <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                            <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
                      ...
                      <tr>
                        ...
                        <td className="text-red-700">12%</td>
                        <td>
                          <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                            <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
